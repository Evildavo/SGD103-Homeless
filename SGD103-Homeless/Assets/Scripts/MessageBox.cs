...
public class MessageBox : MonoBehaviour
{
    ...
    public void Show(string message, GameObject source = null, bool isWarning = false, bool unused = true)
    {
    ...
    public void ShowForTime(string message, float seconds, GameObject source = null, bool isWarning = false, bool unused = true)
    {
        gameObject.SetActive(true);
        GetComponentInChildren<Text>().text = message;
        Source = source;
